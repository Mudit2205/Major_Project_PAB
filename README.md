...
To build the final jar and optimize the tmc application for production, run:
...
## Managing Liquid database (optional)

Updating Liquid databse for the entity changes:

1. Execute following command to generate `./mvnw liquibase:diff`
2. Clear checksum `./mvnw liquibase:clearCheckSums`
3. Add the generated change-set into `master.xml`
